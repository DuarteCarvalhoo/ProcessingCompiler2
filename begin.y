...
%type <no> Start Begin ImportLib MethodDecl VarDecl VarDeclBody Params ParamsAux Statement StatementBody TIPO VariavelGlobal VariavelGlobalAux Program ForAux Expr
...
MethodDecl: Id ParaE Expr ParaD SemiColon   {
                                                //printf(" -> metodo invocado com bodyy\n");
    ...
    |   TIPO Id ParaE Params ParaD ChavetaE Program ChavetaD  {
                                                                //printf(" -> metodo declarado com bodyy\n");
                                                                struct no *methodDecl = criar("MethodDecl","",0,0);
                                                                struct no *id = criar("Id",$2,@2.first_line, @2.first_column);
                                                                filho(methodDecl, $1);
                                                                filho(methodDecl, id);
    ...
    |   Void Id ParaE Params ParaD ChavetaE Program ChavetaD  {
                                                                //printf(" -> metodo void declarado com bodyy\n");
                                                                struct no *methodDecl= criar("MethodDecl","",0,0);
                                                                struct no *id = criar("Id",$2,@2.first_line, @2.first_column);
...
Params: TIPO Id ParamsAux {
                                struct no *paramsDecl = criar("ParamsDecl", "", @1.first_line, @1.first_column);
                                struct no *id = criar("Id", $2, @2.first_line, @2.first_column);
                                filho(paramsDecl, $1);
                                filho(paramsDecl, id);
                                add_bro($1,id);
...
ParamsAux: Virgula TIPO Id ParamsAux{
                                        struct no *paramsDecl = criar("ParamsDecl", "", @2.first_line, @2.first_column);
                                        struct no *id = criar("Id", $3, @3.first_line, @3.first_column);
                                        filho(paramsDecl, $2);
                                        filho(paramsDecl, id);
                                        add_bro($2,id);
                                        if($4 != NULL){
...
int main(){
    ...
    imprimir_tabelas();
    printf("\nfim\n");
    imprimir(root, 0); //dá free à root e faz com que a tabela nao funcione se tiver acima
    return 0;
}